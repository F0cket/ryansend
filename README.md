...
```
docker run -d --name ryansend -p 3000:3000 -p 3001:3001 -v /mnt/user/appdata/ryansend:/data -v /mnt/user/:/shared -e RYANSEND_ADMIN_SHARING_ROOT=/shared -e RYANSEND_DEFAULT_ADMIN_PANEL=true -e RUST_LOG=info -e RYANSEND_BASE_URL=https://example.com docker.io/ryanlittlefield/ryansend:1.7.2
```
